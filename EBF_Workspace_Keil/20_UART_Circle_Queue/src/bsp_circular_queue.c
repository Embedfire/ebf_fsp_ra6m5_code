 ...
 */
bool Queue_Init(volatile Circular_queue_t *circular_queue)
{
    if (!circular_queue)
        return false;
    memset ((void *)circular_queue, 0, sizeof(Circular_queue_t));
    return true;
}
 ...
 */
bool Queue_isEmpty(volatile Circular_queue_t *circular_queue)
{
    if (!circular_queue)
        return false;
 ...
 */
bool Queue_isFull(volatile Circular_queue_t *circular_queue)
{
    if (!circular_queue)
        return false;
 ...
 * @return len_haduse
 */
uint16_t Queue_HadUse(volatile Circular_queue_t *circular_queue)
{
    if (!circular_queue)
        return false;
 ...
 * @return len_NoUse
 */
uint16_t Queue_NoUse(volatile Circular_queue_t *circular_queue)
{
    if (!circular_queue)
        return false;
 ...
 */
bool Queue_Wirte(volatile Circular_queue_t *circular_queue, uint8_t *string, uint16_t len)
{
    if (!circular_queue)
        return false;
 ...
 */
bool Queue_Read(volatile Circular_queue_t *circular_queue, uint8_t *string, uint16_t len)
{
    if (!circular_queue)
            return false;
