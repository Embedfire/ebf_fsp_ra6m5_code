...
void CAN0_Operation(void)
{
    ...
    /* 填充将要传输的帧数据 */
    memcpy((uint8_t*)&canfd0_tx_frame.data[0], (uint8_t*)&tx_data[0], CAN_CLASSIC_FRAME_DATA_BYTES);


    CANFD0_MSG_PRINTF("CANFD0 正在使用传统 CAN 帧传输数据");
