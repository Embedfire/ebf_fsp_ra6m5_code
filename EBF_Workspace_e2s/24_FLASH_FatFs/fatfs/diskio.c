...
)
{
	...
	case QSPI_FLASH :  /* QSPI FLASH */
	      ...
	      if ((QSPI_FLASH_ReadID() == FLASH_ID_W25Q32JV)||(QSPI_FLASH_ReadID() == FLASH_ID_AT25SF321B))
	      {
	         // printf("good\r\n");
	        /* 设备ID读取结果正确 */
	        stat = RES_OK;
...
)
{
    ...
    case QSPI_FLASH :  /* QSPI FLASH */
        ...
        R_QSPI_Read(&Flash_ctrl, buff , sector <<12, count<<12);
        res = RES_OK;
        return res;
...
)
{
    ...
    case QSPI_FLASH :  /* QSPI FLASH */
        ...
        R_QSPI_Erase(&Flash_ctrl, write_addr, 4096);
